...
```{r total_costs_print, echo = FALSE, results = "asis"}
...
```{r mortgage_parts, echo = FALSE, results = "asis"}
mortgage_parts <- list()
...
```{r option1_fig, echo = FALSE, fig.width = 10, fig.height = 5}
ribbon.plot.pay(pay[[1]], xmax = timeHorizon, ymax = ymax)
```{r option1_table, echo = FALSE, results = "asis"}
summaryPay(pay[[1]], timeHorizon = timeHorizon, xtable = TRUE)
```

### Option 2: `r desc[[2]]`

```{r option2_fig, echo = FALSE, fig.width = 10, fig.height = 5}
ribbon.plot.pay(pay[[2]], xmax = timeHorizon, ymax = ymax)
```{r option2_table, echo = FALSE, results = "asis"}
summaryPay(pay[[2]], timeHorizon = timeHorizon, xtable = TRUE)
```

### Option 3: `r desc[[3]]`

```{r option3_fig, echo = FALSE, fig.width = 10, fig.height = 5}
ribbon.plot.pay(pay[[3]], xmax = timeHorizon, ymax = ymax)
```{r option3_table, echo = FALSE, results = "asis"}
