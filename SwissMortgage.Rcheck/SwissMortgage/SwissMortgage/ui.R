...
shinyUI(pageWithSidebar(
  ...
  sidebarPanel(
    ...
    conditionalPanel(
      ...
      sliderInput("renew2", "Period for renewed mortgage (0 = not renew):", min = 0, max = 10, value = 0, step = 1)
    ),
    ...
    conditionalPanel(
      ...
      sliderInput("period3", "Period (years) for mortgage:", min = 0, max = 10, value = 2, step = 1),
      sliderInput("renew3", "Period for renewed mortgage (0 = not renew):", min = 0, max = 10, value = 0, step = 1)
    ),
    ...
    conditionalPanel(
      ...
      sliderInput("period4", "Period (years) for mortgage:", min = 0, max = 10, value = 2, step = 1),
      sliderInput("renew4", "Period for renewed mortgage (0 = not renew):", min = 0, max = 10, value = 0, step = 1)
    ),
